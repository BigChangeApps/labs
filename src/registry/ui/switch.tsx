...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-hidden focus-visible:border-hw-focus focus-visible:ring-hw-focus/30 focus-visible:ring-4 dark:focus-visible:ring-hw-focus/30 focus-visible:ring-offset-2 focus-visible:ring-offset-hw-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-hw-brand data-[state=checked]:ring-1 data-[state=checked]:ring-hw-brand-hover data-[state=unchecked]:bg-hw-inactive/50",
      className
    )}
    {...props}
    ref={ref}
