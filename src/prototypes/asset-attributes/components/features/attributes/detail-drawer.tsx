...
import { getAttributeTypeLabel } from "../../../lib/utils";
...
export function AttributeDetailDrawer({
  ...
  const handleDelete = () => {
    if (
      ...
      if (attributeId && currentCategoryId) {
        deleteAttribute(attributeId, currentCategoryId);
      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent>
          ...
          <div className="space-y-6 py-6">
            ...
            <div className="space-y-2">
              <Label>Type</Label>
              <Input value={getAttributeTypeLabel(type)} disabled />
            </div>
