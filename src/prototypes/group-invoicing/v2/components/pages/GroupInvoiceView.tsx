...
function LinesBadge({
  ...
  if (isPartial && selected !== undefined) {
    return (
      <Badge
        variant="outline"
        className="rounded-md bg-hw-brand/10 border-hw-brand/20 text-sm font-medium text-hw-brand tracking-[-0.14px] w-fit"
      >
  ...
  return (
    <Badge
      variant="outline"
      className="rounded-md bg-white text-sm font-medium text-hw-text-secondary tracking-[-0.14px] w-fit"
    >
      {total} lines
    </Badge>
  );
...
function JobTypeBadge({ type }: { type: string }) {
  return (
    <Badge
      variant="outline"
      className="rounded-md bg-white text-sm font-medium text-hw-text-secondary tracking-[-0.14px]"
    >
      {type}
    </Badge>
  );
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      <div className="flex items-center gap-1">
        ...
        {showHelp && <HelpCircle className="h-4 w-4 text-hw-text-secondary" />}
      </div>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button 
            className="flex items-center justify-between w-full px-2 py-1.5 bg-white rounded-md shadow-[0px_0px_0px_1px_rgba(3,7,18,0.08),0px_0.5px_2px_0px_rgba(11,38,66,0.16)] hover:bg-hw-surface-hover transition-colors"
          >
            <span className="text-sm font-medium text-hw-text tracking-[-0.14px]">{structureLabels[value]}</span>
      ...
      <div className="bg-hw-surface-subtle border-b border-hw-border px-3 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-hw-text-secondary tracking-[-0.14px]">{dateRange}</span>
          </div>
          <div className="flex items-center gap-3">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="bg-white rounded-lg border border-hw-border overflow-hidden">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <span className={cn(
              "text-sm font-bold tracking-[-0.14px]",
              groupLinesSelected ? "text-hw-text" : "text-hw-inactive line-through"
            )}>
  ...
  return (
    <div className="bg-white rounded-lg shadow-[0px_0px_0px_1px_rgba(26,28,46,0.12),0px_1px_2px_-1px_rgba(26,28,46,0.08),0px_2px_4px_0px_rgba(26,28,46,0.06)] p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-1">
          <FileTextIcon />
          <h3 className="text-base font-bold text-hw-text tracking-[-0.16px]">{siteInvoice.siteName}</h3>
        </div>
        <button className="p-0.5 hover:bg-hw-surface-hover rounded">
          <MoreVertical className="h-5 w-5 text-hw-text" />
        </button>
      ...
      <div className="flex justify-between mb-6">
        <div className="w-[179px]">
          <p className="text-sm font-normal text-hw-text tracking-[-0.14px]">Address</p>
          <p className="text-sm font-normal text-hw-text-secondary tracking-[-0.14px] mt-1">{siteInvoice.address}</p>
        </div>
        <div className="w-[134px]">
          <p className="text-sm font-normal text-hw-text tracking-[-0.14px]">Default department</p>
          <p className="text-sm font-normal text-hw-text-secondary tracking-[-0.14px] mt-1">{siteInvoice.department}</p>
        </div>
        <div className="w-[143px]">
          <p className="text-sm font-normal text-hw-text tracking-[-0.14px]">Default nominal code</p>
          <p className="text-sm font-normal text-hw-text-secondary tracking-[-0.14px] mt-1">{siteInvoice.nominalCode}</p>
        </div>
      </div>
        ...
        {Object.entries(jobsByCategory).map(([category, jobs]) => {
          ...
          return (
            <div key={category} className="space-y-2">
              <p className="text-sm font-medium text-hw-text-secondary tracking-[-0.14px]">{category}</p>
              {jobs.map(job => {
                if (job.isGroupJob && job.childJobs) {
                  return (
                    <GroupJobCard
      ...
      <div className="bg-hw-surface-subtle rounded-lg p-4">
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-hw-text tracking-[-0.14px]">Total VAT</span>
            <span className="text-sm font-medium text-hw-text tracking-[-0.14px]">10%</span>
          </div>
          <div className="flex items-center justify-between pt-3 border-t border-hw-border">
            <span className="text-base font-bold text-hw-text tracking-[-0.16px]">Total</span>
    ...
    <div className="bg-white rounded-lg shadow-[0px_0px_0px_1px_rgba(3,7,18,0.08),0px_0.5px_2px_0px_rgba(11,38,66,0.16)] overflow-hidden">
      ...
      <div className="px-4 pt-6 pb-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-base font-bold text-hw-text tracking-[-0.16px]">Overview</span>
          <div className="flex items-center gap-1">
            <DraftBadge />
            <button className="p-0.5 hover:bg-hw-surface-hover rounded">
              <MoreVertical className="h-5 w-5 text-hw-text" />
        ...
        <p className="text-sm font-medium text-hw-text-secondary tracking-[-0.14px]">{invoiceId}</p>
      </div>
      ...
      {/* Divider */}
      <div className="border-t border-hw-border px-5 py-4">
        <div className="space-y-1">
          <p className="text-sm font-medium text-hw-text-secondary tracking-[-0.14px]">
      ...
      <div className="bg-hw-surface-subtle border-t border-hw-border px-5 py-4 space-y-4">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm font-normal text-hw-text tracking-[-0.14px]">Sub-total</span>
            <span className="text-sm font-normal text-hw-text tracking-[-0.14px]">{formatCurrency(subtotal)}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm font-normal text-hw-text tracking-[-0.14px]">Total VAT</span>
            <span className="text-sm font-normal text-hw-text tracking-[-0.14px]">10%</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-base font-bold text-hw-text tracking-[-0.16px]">Group Invoice Total</span>
            <span className="text-base font-bold text-hw-text tracking-[-0.16px]">{formatCurrency(total)}</span>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="text-center">
          <p className="text-lg text-hw-text-secondary mb-4">No jobs selected for invoicing</p>
        ...
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm font-bold text-hw-text tracking-[-0.14px]">{invoiceId}</span>
            </div>
            <DraftBadge />
          </div>
