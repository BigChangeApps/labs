  ...
  return (
    <div className="border border-[rgba(26,28,46,0.12)] rounded-lg overflow-hidden">
      ...
      <div className="flex items-center gap-5 px-3 py-2 bg-[#FCFCFD] border-b border-[rgba(16,25,41,0.1)]">
        ...
        <span className="w-24 text-sm font-medium text-[#73777D] tracking-[-0.14px] text-right">Unit price</span>
        <span className="w-24 text-sm font-medium text-[#73777D] tracking-[-0.14px] text-right">Total</span>
          ...
          return (
            <div key={item.id} className="flex items-center gap-5 px-3 py-2 bg-white hover:bg-[#F8F9FC] transition-colors min-h-[40px] max-h-[56px]">
              <div className="flex-1 flex items-center gap-2.5">
                ...
                <span className="text-sm font-medium text-[#0B2642] tracking-[-0.14px]">{item.jobRef}</span>
              </div>
              <span className="w-24 text-sm font-medium text-[#0B2642] tracking-[-0.14px] text-right">{formatCurrency(item.unitPrice)}</span>
              <span className="w-24 text-sm font-medium text-[#0B2642] tracking-[-0.14px] text-right">{formatCurrency(item.total)}</span>
              <button 
                onClick={() => onEditLineItem?.(item)}
                className="p-1 hover:bg-[rgba(11,38,66,0.08)] rounded transition-colors"
                aria-label="Edit line item"
              >
                <Pencil className="h-4 w-4 text-[#73777D]" />
              </button>
            </div>
          );
        })}
    ...
    <div className="h-screen bg-[#FCFCFD] flex flex-col overflow-hidden">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-[rgba(26,28,46,0.12)] shrink-0">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="font-bold text-[#0B2642]">Invoice/{invoiceData.invoiceNumber.toString().padStart(4, "0")}</span>
          ...
          <div className="bg-white w-[592px] shadow-[0px_0px_0px_1px_rgba(26,28,46,0.08),0px_16px_32px_0px_rgba(26,28,46,0.08),0px_2px_24px_0px_rgba(26,28,46,0.08)] relative">
            ...
            <div className="p-6 space-y-6 relative z-10">
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-medium text-[#73777D] tracking-[-0.14px]">From:</p>
                  <div className="space-y-1">
                    <p className="text-sm font-bold text-[#0B2642] tracking-[-0.14px]">BigChange Ltd</p>
                        ...
                        <PopoverTrigger asChild>
                          <button 
                            ...
                            className={cn(
                              ...
                              invoiceData.issueDate ? "text-[#0B2642]" : "text-[rgba(11,38,66,0.4)]"
                            )}
                          >
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <button 
                            ...
                            className={cn(
                              "text-sm tracking-[-0.14px] hover:underline cursor-pointer text-right",
                              invoiceData.dueDate ? "text-[#0B2642]" : "text-[rgba(11,38,66,0.4)]"
                            )}
                          >
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex flex-col gap-1 items-end text-right">
                      ...
                      <input
                        ...
                        className="text-sm text-[#0B2642] tracking-[-0.14px] text-right bg-transparent border-none outline-none hover:underline focus:underline w-[80px]"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1 items-end text-right">
                      ...
                      <input
                        ...
                        className="text-sm text-[#0B2642] tracking-[-0.14px] text-right bg-transparent border-none outline-none hover:underline focus:underline w-[80px] placeholder:text-[rgba(11,38,66,0.4)]"
                      />
                    </div>
                  </div>
                </div>
              ...
              {/* Bill To */}
              <div className="space-y-2">
                <p className="text-sm font-medium text-[#73777D] tracking-[-0.14px]">Bill To:</p>
                <div className="space-y-0.5">
                  <p className="text-sm font-medium text-[#0B2642] tracking-[-0.14px]">{invoiceData.name}</p>
                  <p className="text-sm text-[#0B2642] tracking-[-0.14px]">{invoiceData.address}</p>
                </div>
              </div>

              {/* Invoice Title - Editable */}
              <div className="space-y-1.5">
                <p className="text-sm font-medium text-[#73777D] tracking-[-0.14px]">Invoice title</p>
                <div className="w-[190px]">
                  <input
                    ...
                    onChange={(e) => updateInvoiceField("title", e.target.value)}
                    placeholder="Enter invoice title..."
                    className="w-full h-8 px-2.5 py-1.5 text-sm font-medium text-[#0B2642] tracking-[-0.14px] bg-white rounded shadow-[0px_0px_0px_1px_rgba(3,7,18,0.08),0px_0.5px_2px_0px_rgba(11,38,66,0.16)] focus:outline-none focus:ring-1 focus:ring-[#086DFF] placeholder:text-[rgba(11,38,66,0.4)]"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="px-6 space-y-2 relative z-10">
              {/* Jobs Heading */}
              <h3 className="text-base font-medium text-[#73777D] tracking-[-0.16px]">Jobs</h3>
            ...
            <div className="px-6 pb-6 relative z-10">
              ...
              <div className="flex gap-10 pt-6">
                ...
                <div className="flex-1 space-y-6">
                  {/* Notes - Editable */}
                  <div className="space-y-1.5">
                    <p className="text-sm font-medium text-[#73777D] tracking-[-0.14px]">Notes</p>
                    <textarea
                      value={invoiceData.notes}
                      onChange={(e) => setInvoiceData((prev) => ({ ...prev, notes: e.target.value }))}
                      placeholder="Add notes..."
                      className="w-full h-[66px] px-2 py-2 bg-white rounded text-sm text-[#0B2642] placeholder:text-[rgba(11,38,66,0.4)] resize-none border border-[rgba(3,7,18,0.08)] shadow-[0px_0.5px_2px_0px_rgba(11,38,66,0.16)] focus:outline-none focus:ring-1 focus:ring-[#086DFF]"
                    />
                  </div>
