        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="border border-hw-border rounded-lg overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-2 bg-white border-b border-hw-border">
              ...
              <span className="w-16 text-sm font-medium text-[#0B2642] tracking-[-0.14px] text-center">
                Qty
              </span>
              <span className="w-24 text-sm font-medium text-[#0B2642] tracking-[-0.14px] text-right">
                Unit price
              </span>
              <span className="w-24 text-sm font-medium text-[#0B2642] tracking-[-0.14px] text-right">
                Total
            ...
            <div className="divide-y divide-hw-border">
              {localLineItems.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center gap-3 px-4 py-3 bg-white hover:bg-[#F8F9FC] transition-colors"
                >
                  <Checkbox
                  ...
                  <span className="w-16 text-sm font-normal text-[#0B2642] tracking-[-0.14px] text-center">
                    {item.quantity.toFixed(1)}
                  </span>
                  <span className="w-24 text-sm font-normal text-[#0B2642] tracking-[-0.14px] text-right">
